    ...
    <>
      <Card>
        <CardContent>
          ...
          <Link href={"https://www.linkedin.com/in/lucas-bittencourt-rauch-b40967243"} target="_blank">
            <ContactTypography variant={titleVariant} sx={{display:'flex', alignItems:"center", my:2}}>
